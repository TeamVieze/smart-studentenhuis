...
<html lang="en-gb" dir="ltr">
    ...
    <!-- Navigatiebalk --> 
            <nav class="uk-navbar" data-uk-sticky data-uk-scrollspy="{cls:'uk-animation-slide-top',delay:300}">
                ...
                <div class="uk-navbar-brand uk-navbar-center uk-visible-small navtekst">Keuken</div>
                </div>
            </nav>
            <!-- Einde navigatiebalk --> 
   ...
   <ul class="uk-breadcrumb">
    ...
    <li class="uk-active nu"><span>Keuken</span></li>
   </ul>
   <!--Einde breadcrumbs-->
    ...
    <hr class="uk-article-divider dividemetmargin">     
            ...
            <div class="uk-grid">
                ...
                <div class="uk-width-medium-1-1">
                    ...
                    <div class="uk-vertical-align uk-text-center" style="background: url('images/kitchen.jpg') no-repeat; background-size: cover; height: 500px;">
                        <div class="uk-vertical-align-middle uk-width-1-2">
                            <h2 class="uk-heading-large">De keuken is op dit moment: <div class="uk-alert uk-alert-success">VRIJ</div></h2>
                        </div>
                    </div>
        ...
        <div id="modalreserveren" class="uk-modal">
                             ...
                             <div id="modaloverzicht" class="uk-modal">
                                <div class="uk-modal-dialog">
                                    <button type="button" class="uk-modal-close uk-close"></button>
                                    <div class="uk-modal-header">
                                        <h2>Mijn keuken reserveringen</h2>
                                    </div>
                                            ...
                                            <div class="uk-form uk-width-1-1">
                                               ...
                                               <hr class="uk-article-divider dividereserv">
                                                    ...
                                                    <article class="uk-comment">
                                                        ...
                                                        <div class="uk-comment-body">
                                                            <p>Graag wil ik 's ochtends de keuken gebruiken zodat ik op tijd kan zijn voor mijn tentamen.  </p>
                                                             <p>
                                                                    <a class="uk-button uk-button-primary " href="">Bewerken</a>
                                                                    <a class="uk-button uk-button-primary " href="">Verwijderen</a>
                                                            </p>    
