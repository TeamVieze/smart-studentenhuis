    ...
    <hr class="uk-article-divider dividemetmargin">     
            ...
            <div class="uk-grid">
                ...
                <div class="uk-width-medium-1-1">
                    ...
                    <div class="uk-vertical-align uk-text-center" style="background: url('images/livingroom.jpg') no-repeat; background-size: cover; height: 500px;">
                        <div class="uk-vertical-align-middle uk-width-1-2">
                            <h2 class="uk-heading-large">De woonkamer is op dit moment: <div class="uk-alert uk-alert-success">VRIJ</div></h2>
                        </div>
                    </div>
