    ...
    <body>
        ...
        <div class="uk-grid">
            <div class="uk-width-1-1 uk-margin-bottom">
                <h2 class="uk-h1"><i class="uk-icon-home uk-text-primary"></i> Hoogstraat 9A</h2>
            </div>

            <div class="uk-width-large-1-4 uk-width-medium-1-1 uk-width-small-1-1 uk-margin-bottom">
                <img src="images/jorn.jpg" alt="" height="200" width="200">
            </div>
